...
@if($user_is_act)
<div class="cl mt-10"> 
	<span class="l act-span" data-url="{{url('manage/section')}}">
		<a class="btn btn-primary radius add-r" data-for="section" data-title="添加标段" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>添加标段</a>
		<a class="btn btn-secondary radius edit-r" data-for="section" data-title="编辑标段" data-url="{{url('manage/section')}}" href="javascript:;"><i class="Hui-iconfont">&#xe6df;</i>编辑标段</a>
		<a class="btn btn-danger radius del-r" href="javascript:;" data-id="" data-url="{{url('manage/section')}}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i>删除标段</a>
	</span>
</div>
@endif
