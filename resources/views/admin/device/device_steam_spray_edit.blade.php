...
@section('container')
    ...
    <form class="form form-horizontal" id="form_container" data-url="{{url('manage/steam_spray_device_edit')}}">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text msg_must" value="{{$device_data['parame1']}}" placeholder="请输入增压泵额定功率(kw)" id="parame1" name="parame1">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>增压泵扬程(M)：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text msg_must" value="{{$device_data['parame2']}}" placeholder="请输入增压泵扬程(M)" id="parame2" name="parame2">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>最大养生梁数量(个)：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text msg_must" value="{{$device_data['parame3']}}" placeholder="请输入最大养生梁数量" id="parame3" name="parame3">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>最大养生时间(D)：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text msg_must" value="{{$device_data['parame4']}}" placeholder="请输入最大养生时间(D)" id="parame4" name="parame4">
            </div>
        </div>
        <div class="row cl">
