                    ...
                    <tr class="text-c">
                        ...
                        @if($user_is_act)
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="mt-5 device_edit btn btn-secondary radius size-MINI" data-for="section" data-title="编辑设备" data-url="{{url('manage/beam_yard_device_edit'.'/'.$v['id'])}}" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
@section('layer')
    @include('admin.device.beam_yard_device_add')
@stop
