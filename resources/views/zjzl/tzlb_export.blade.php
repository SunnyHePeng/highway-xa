...
<div class="cl pd-5 bg-1 bk-gray mt-20 hidden-xs noprint"> 
  <span class="ml-10 export-file export-excel" data-name="拌和站信息化不合格处理台账" data-obj="table" data-type="excel"><a href="javascript:;" title="导为excel文件"><img src="/static/admin/images/excel.svg"></a></span>
  <span onclick="javascript:window.print();" class="ml-10" data-name="拌和站信息化不合格处理台账"><a href="javascript:;" title="打印文件"><img src="/static/admin/images/dayin.svg"></a></span>
</div>
<!--startprint-->
<div class="mt-10 dataTables_wrapper">
  <h2 class="text-c" style="width:1730px;">{{$sec_name}} {{$start_date}}~{{$end_date}}拌和站信息化不合格处理台账</h2>
