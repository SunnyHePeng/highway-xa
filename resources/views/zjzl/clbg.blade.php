...
<article class="page-container" id="show_detail" style="width:780px; margin: 0 auto;">
	...
	<div class="row cl">
	  <div class="col-xs-12 col-sm-12" class="padding-left: 0;">
	  	...
	  	<h2 class="text-c">拌和站信息化不合格处理记录表</h2>
          ...
          <tdead>
            ...
            <tr height="150px">
              <td width="120">建设单位原因分析及处理结果</td>
              <td>{{$pro_info}}</td>
            </tr>
          </tdead>
        </table>
        <div class="col-xs-4 col-sm-4" class="padding-left: 0;">建设单位:{{$pro_name}}</div>
        <div class="col-xs-4 col-sm-4" class="padding-left: 0;">监理单位:{{$sup_name}}</div>
        <div class="col-xs-4 col-sm-4" class="padding-left: 0;">施工单位:{{$sec_name}}</div>
	  </div>
	</div>
</article>
@stop
