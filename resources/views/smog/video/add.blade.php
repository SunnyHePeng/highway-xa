...
@section('container')
    ...
    <form class="form form-horizontal" id="form_container" data-url="{{url('smog/video/store')}}">

        <div class="formControls col-xs-10 col-sm-10">
            <label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" placeholder="请输入标题" id="title" name="title" class="textarea radius size-S" style="font-size: 20px;">
            </div>
        </div>

        <div class="formControls col-xs-10 col-sm-10 mt-30">
            <label class="form-label col-xs-2 col-sm-2">内容：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <textarea name="description" id="content" placeholder="请输入简介" cols="50" rows="50" class="textarea radius size-XL" style="font-size: 20px; height: 300px;" ></textarea>
            </div>
        </div><br><br>

        <div class="formControls col-xs-10 col-sm-10 mt-30">
            <label class="form-label col-xs-2 col-sm-2">视频文件：</label>
            <div class="formControls col-xs-8 col-sm-8">
                <div class="uploader-thum-container">
                    ...
                    <button id="uploadfiles" class="btn btn-default btn-uploadstar radius ml-10">上传视频</button>
                </div>
                <div class="c-red">支持MP4，flv文件，最大500M</div>
        ...
        <br><br>
        <div class="formControls col-xs-10 col-sm-10 mt-50">
            <label class="form-label col-xs-2 col-sm-2"></label>
            <div class="formControls col-xs-8 col-sm-8">
                <button class="btn  sub btn-primary radius" type="submit">保存视频信息</button>
            </div>
        </div>
    </form>
@stop
...
@section('script')
    ...
    <script type="text/javascript" src="/static/admin/js/file_upload.js"></script>
    <script type="text/javascript" src="/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
    <script type="text/javascript">
        list.init();
        uploadFileWithExtensionAndSize('filePicker', '{{url('smog/video/upload')}}', 'uploadfiles', 'fileList', 'fileShow', {name:'file',type:'file'}, 'file', "mp4,flv", '500mb')
