    ...
    <div id="col-xs-12">
        <div class="mt-10">
            ...
            <div class="col-xs-12 col-md-8">
                <iframe id="data_iframe" src="{{url('smog/data_in_real_time_video_by_device/'.$device['id'])}}" style="border:1px solid #eee;width:99%;height:calc(100vh - 80px)"></iframe>
            </div>
        </div>
    </div>
@stop
...
<script type="text/javascript">
    //污水处理实时视频目前采用ocx-preview方式调用

    //  *****************注释部分代码为ocx-OpenApi方式调用***********************************
//
//    $(function(){
//        var userName='admin';
//        var pw='Hxtm12345+';
