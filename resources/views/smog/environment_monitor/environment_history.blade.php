...
@section('container')
  ...
  <span class="dropDown"> <a class="btn btn-success radius" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">导出</a>
    <ul class="dropDown-menu menu radius box-shadow">
      <li><a href="#" class="export-cur open-iframe" data-title="环境监测历史数据" data-url="{{$url.'&d=cur'.'&page='.$search['page']}}">当前页面数据</a></li>
      <li><a href="#" class="export-all open-iframe" data-title="环境监测历史数据" data-url="{{$url.'&d=all'}}">全部页面数据</a></li>
    </ul>
  </span>
    </div>
