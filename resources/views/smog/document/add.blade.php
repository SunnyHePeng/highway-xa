...
@section('container')
    ...
    <form class="form form-horizontal" id="form_container" data-url="{{url('smog/document/store')}}">
        ...
        <div class="formControls col-xs-10 col-sm-10 mt-30">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                ...
                <div class="c-red">仅支持pdf文件，最大5M</div>
        ...
        <div class="formControls col-xs-10 col-sm-10 mt-50">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <button class="btn  sub btn-primary radius" type="submit">保存文档信息</button>
            </div>
        </div>
    </form>
@stop
...
@section('script')
    ...
    <script type="text/javascript">
        list.init();
        uploadFileWithExtensionAndSize('filePicker', '{{url('smog/document/upload')}}', 'uploadfiles', 'fileList', 'fileShow', {name:'file',type:'file'}, 'file', "pdf", '10mb')
