    ...
    <article class="page-container" id="show_detail" style="width:780px; margin: 0 auto;">
        ...
        <div class="row cl">
            <div class="col-xs-12 col-sm-12" class="padding-left: 0;">
                <h1 class="text-c"></h1>
                <h2 class="text-c">张拉信息化不合格处理记录表</h2>
                <p class="f-r">编号：第{{$detail->info->section->name}}-{{date('YmdHis',$detail->stretch_time)}}号</p>
                <table class="table table-border table-bordered table-bg">
                    <tdead>
                        ...
                        <tr>
                            <td width="120">张拉日期</td>
                            <td>{{date('Y-m-d H:i:s',$detail->stretch_time)}}</td>
                        </tr>
                        <tr>
                            <td width="120">张拉梁号</td>
                            <td>
