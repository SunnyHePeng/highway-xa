...
@section('script')
    ...
    <script type="text/javascript">
        ...
        uploadFile('imgPicker', '{{url('stretch/file/upload')}}', 'uploadimg', 'imgList', 'imgShow', {name:'thumb',type:'images'}, 'thumb')
        uploadFile('filePicker', '{{url('stretch/file/upload')}}', 'uploadfiles', 'fileList', 'fileShow', {name:'file',type:'file'}, 'file')
