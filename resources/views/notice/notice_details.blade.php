...
@section('container')
    ...
    <div class="codeView docs-example-accessory">
        @if($notice)
            ...
            @else
                <input class="btn btn-success radius mt-20 download-file" type="button" value="下载附件" data-url1="{{url('notice/download/'.$notice->id)}}" data-url2="{{url('notice/download_number_augment/'.$notice->id)}}">
            @endif
        @endif
    </div>
