...
@section('container')
    ...
    <form class="form form-horizontal" id="form_container" data-url="{{url('notice/notice_edit')}}">
        ...
        <div class="formControls col-xs-12 col-sm-10">
            ...
            <div class="formControls col-xs-10 col-sm-8">
                <input type="text" placeholder="请输入标题，不能超过50个字符" value="@if($notice){{$notice->title}}@endif" id="title" name="title" class="textarea radius size-S" style="font-size: 20px;">
            </div>
        </div>
        ...
        <div class="formControls col-xs-12 col-sm-10 mt-30">
            ...
            <div class="formControls col-xs-10 col-sm-8">
                <textarea name="content" id="content" placeholder="请输入内容" cols="50" rows="50" class="textarea radius size-XL" style="font-size: 20px; height: 300px;" >@if($notice){{$notice->content}}@endif</textarea>
            </div>
        </div><br><br>
        ...
        <div class="formControls col-xs-12 col-sm-10 mt-30">
            ...
            <div class="formControls col-xs-10 col-sm-8">
                ...
                <div class="c-red">如果附件需要修改，请直接上传,支持doc,docx,txt,xls,xlsx最大1M</div>
        ...
        <div class="formControls col-xs-12 col-sm-10 mt-50">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <button class="btn  sub btn-primary radius" type="submit">修改公告</button>
            </div>
        </div>
    </form>
@stop
