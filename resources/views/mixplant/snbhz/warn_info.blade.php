	...
	<table id="table_list" class="table table-border table-bordered table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="150" class="hidden-xs">生产时间</th>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="f-14 product-brand-manage td-manage"> 
				  	<a style="text-decoration:none" class="mt-5 ml-5 open-iframe btn btn-secondary radius size-MINI" href="javascript:;" data-title="拌和详细信息" data-url="{{url('snbhz/detail_info?id='.$value['id'])}}">拌和信息</a>
				  	<a style="text-decoration:none" class="mt-5 ml-5 open-iframe btn btn-secondary radius size-MINI" href="javascript:;"  data-title="处理报告" data-url="{{url('snbhz/clbg?id='.$value['id'])}}">处理报告</a>
          		</td>
			</tr>
			@endforeach
			@endif
...
var url = "{{url('snbhz/get_select_val')}}";
//项目改变 获取对应的监理 标段 设备
