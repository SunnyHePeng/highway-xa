		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="f-14 product-brand-manage td-manage"> 
				  	<a style="text-decoration:none" class="mt-5 ml-5 open-iframe btn btn-secondary radius size-MINI" href="javascript:;" data-title="{{$value['section']['name']}}-{{$value['name']}} 拌和数据" data-url="{{url('snbhz/product_data_info/'.$value['id'].'?pro_id='.$value['project_id'])}}">拌和数据</a>
          		</td>
			</tr>
			@endforeach
			@endif
