        ...
        success:function(data){
            if(data.data.length>0){
                ...
                for(var i=0;i<mess.length;i++){
                    ...
                    str +="<span>"+"<a data-title='拌和详细信息' href='javascript:;' data-url='"+url+"' class='open-iframe' onclick='common.openIframe($(this).attr(\"data-title\"), $(this).attr(\"data-url\"), true)'>"+mess[i].section.name+'标段'+'-'+mess[i].device.name+"报警:"+mess[i].warn_info+"</a>"+"</span>"+"<br>";
