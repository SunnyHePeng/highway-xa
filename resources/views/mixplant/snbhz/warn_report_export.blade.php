...
<article class="cl pd-10">
	<div class="cl pd-5 bg-1 bk-gray noprint"> 
	  ...
	  <span class="ml-10" onclick="javascript:window.print();" data-name="报警统计报表"><a href="javascript:;" title="打印文件"><img src="/static/admin/images/dayin.svg"></a></span>
	</div>
	<div class="mt-10 dataTables_wrapper">
		<h3 class="text-c">{{$search['start_date']}}~{{$search['end_date']}}拌和站报警统计报表</h3>
