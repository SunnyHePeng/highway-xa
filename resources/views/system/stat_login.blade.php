...
<div>
  <form id="search_form" data="sec_id,start_date,end_date" method="get" data-url="{{$url}}">
        日期范围：
...
<div class="mt-10 dataTables_wrapper" id="page-print">
  <h4 class="print text-c">{{$search['start_date']}}~{{$search['end_date']}} {{$sec_name}} {{$module}}用户登录统计</h4>
