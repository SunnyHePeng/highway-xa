...
@section('container')
    ...
    <div id="open_new">
        <p style="color:red;">仅支持IE,请使用IE8以上浏览器，且需安装控件包和补丁包。
        ...
        <div class="mt-10">
            ...
            <div style="margin-left:490px;">
                <iframe id="data_iframe"  src="{{url('lab/get_aggregate_data_at_video/'.$device['id'])}}" style="border:1px solid #eee;width:100%;height:95%;"></iframe>
            </div>
        </div>
    </div>
@stop
