    ...
    <table class="table table-border table-bordered table-bg">
      <thead>
        <tr class="@if($lab_info['is_warn']) red-line @else blue-line @endif">
          ...
          <th class="text-r" width="100">有效力值</th>
        ...
        <tr>
          <th class="text-r" width="100">监理</th>
          <td>{{$lab_info['section']['sup'][0]['name']}}</td> 
          <th class="text-r" width="100">合同段</th>
          <td>{{$lab_info['section']['name']}}</td>               
          <th class="text-r" width="100">试验时间</th>
          <td>{{$lab_info['time']}}</td>
        </tr>
        <tr>
          <th class="text-r" width="100">试验编号</th>
          <td>{{$lab_info['sybh']}}</td> 
        ...
        <tr>
          <th class="text-r" width="100">试验品种</th>
          <td>{{$lab_info['sypz']}}</td> 
          <th class="text-r" width="100">试验龄期(天)</th>
          <td>{{$lab_info['sylq']}}</td>               
          <th class="text-r" width="100">强度等级</th>
          <td>{{$lab_info['qddj']}}</td>
        </tr>
        <tr>
          ...
          <td>{{$lab_info['lbph']}}</td>               
          <th class="text-r" width="100">试件规格</th>
          <td>{{$lab_info['sjgg']}}</td>
        </tr>
        <tr>
          <th class="text-r" width="100">试件个数</th>
          <td>{{$lab_info['sjgs']}}</td> 
          <th class="text-r" width="100">加载速率</th>
          <td>{{$lab_info['jzsl']}}</td>               
          <th class="text-r" width="100">有效力值（KN）</th>
          <td>{{$lab_info['yxlz']}}</td>
        </tr>
        <tr>
          <th class="text-r" width="100">有效强度（MPa）</th>
          <td>{{$lab_info['yxqd']}}</td> 
          <th class="text-r" width="100">下屈服强度</th>
          <td>{{$lab_info['xqfqd']}}</td>               
          <th class="text-r" width="100">抗拉强度</th>
          <td>{{$lab_info['klqd']}}</td>
        </tr>
        <tr>
          <th class="text-r" width="100">下屈服力值</th>
          <td>{{$lab_info['xqflz']}}</td> 
          <th class="text-r" width="100">极限载荷</th>
          <td>{{$lab_info['jxzh']}}</td>               
          <th class="text-r" width="100">极限强度</th>
          <td>{{$lab_info['jxqd']}}</td>
        </tr>
      </thead>
    </table>
