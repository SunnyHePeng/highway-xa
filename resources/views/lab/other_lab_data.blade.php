...
@section('container')
    <div class="mt-20">
        <a style="text-decoration:none" class="mt-5 ml-5 open-iframe btn btn-secondary radius" href="javascript:;" data-title="{{$ztree_name}} 其他试验数据列表" data-url="{{url('lab/other_lab_data_info?'.$tree_key.'='.$tree_value)}}">其他试验数据列表</a>
    </div>
    <div class="mt-20">
