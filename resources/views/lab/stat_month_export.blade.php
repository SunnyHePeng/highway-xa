...
<article class="cl pd-10">
	<div class="cl pd-5 bg-1 bk-gray noprint"> 
	  <!-- <span class="ml-10 export-file export-pdf" data-name="试验室月报表" data-obj="table_list" data-type="pdf"><a href="javascript:;" title="导为pdf文件"><img src="/static/admin/images/pdf.svg"></a></span> -->
	  <span class="ml-10 export-file export-excel" data-name="试验室月报表" data-obj="table_list" data-type="excel"><a href="javascript:;" title="导为excel文件"><img src="/static/admin/images/excel.svg"></a></span>
	...
	<div class="mt-10 dataTables_wrapper">
		<h2 class="text-c">{{$search['start_date']}}~{{$search['end_date']}}试验室月报表</h2>
		@include('lab._stat_month')
	</div>
</article>
@stop
