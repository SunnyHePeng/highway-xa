...
@section('container')
    ...
    <ul class="dropDown-menu menu radius box-shadow">
      <li><a href="#" class="export-cur open-iframe" data-title="隧道进度统计历史数据" data-url="{{$url.'&d=cur'.'&page='.$search['page']}}">当前页面数据</a></li>
      <li><a href="#" class="export-all open-iframe" data-title="隧道进度统计历史数据" data-url="{{$url.'&d=all'}}">全部页面数据</a></li>
    </ul>
  </span>
