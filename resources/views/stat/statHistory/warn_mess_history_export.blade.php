...
@section('container')
    ...
    <div class="cl pd-5 bg-1 bk-gray noprint">
        <span class="ml-10 export-file export-excel" onclick="layer.msg('正在导出数据,请稍后')" data-name="报警信息统计历史数据" data-obj="print_div" data-type="excel"><a href="javascript:;" title="导为excel文件"><img src="/static/admin/images/excel.svg"></a></span>
    ...
    <div id="print_div">
        <h3 class="text-c">
            @if($search)
                {{$search['start_date'].'~'.$search['end_date']}}隧道监控量测历史
            @endif
